...
Dungeon::Dungeon()
{
    ...
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, false, "PLANTE VERTE", "Vous n'allez quand meme pas vous en prendre a un pauvre petite plante inoffensive ?", MONSTER_1_IMAGE_PATH, 1, 2, 20, 1)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, false, "LOUVETEAU", "Grrraou !! Grrraou !! Oh qu'il est mignon. Ce serait vraiment un honte si un aventurier tuait cette pauvre petite creature uniquement pour gagner des points d'experience.", MONSTER_2_IMAGE_PATH, 5, 2, 25, 1)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, false, "LOUVETEAU", "Grrraou !! Grrraou !! Oh qu'il est mignon. Ce serait vraiment un honte si un aventurier tuait cette pauvre petite creature uniquement pour gagner des points d'experience.", MONSTER_2_IMAGE_PATH, 5, 2, 25, 1)));
    ...
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, false, "ARAIGNEE GEANTE", "Le vieux sorcier vous avait pourtant prevenu : il est interdit d'aller dans la foret interdite !", MONSTER_11_IMAGE_PATH, 25, 10, 50, 5)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, false, "LOUP ALPHA", "Le chef de la meute. Peut-etre que tuer sa progeniture n'etait pas un tres bonne idee. Les loups du nord se rappellent de tout ...", MONSTER_12_IMAGE_PATH, 30, 5, 50, 5)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, false, "LOUP ALPHA", "Le chef de la meute. Peut-etre que tuer sa progeniture n'etait pas un tres bonne idee. Les loups du nord se rappellent de tout ...", MONSTER_12_IMAGE_PATH, 30, 5, 50, 5)));
   ...
   // 40 CARDS
    ...
    _allRooms.push_back(unique_ptr<Room>(new Trap(TRAP, "FLECHES MORTELLES", "Des fleches sortent d'un trou dans le mur et vous en recevez une dans le genou.", TRAP_6_IMAGE_PATH, AGILITY, 10)));
    _allRooms.push_back(unique_ptr<Room>(new Trap(TRAP, "FLECHES MORTELLES", "Des fleches sortent d'un trou dans le mur et vous en recevez une dans le genou.", TRAP_6_IMAGE_PATH, AGILITY, 10)));
    _allRooms.push_back(unique_ptr<Room>(new Trap(TRAP, "FUMEE MALEFIQUE", "Un nuage de fumee multicolore vous entoure. Quand il se dissipe, vous vous rendez compte qu'il vous a pris toute votre armure. Heureusement vous avez encore votre pagne.", TRAP_7_IMAGE_PATH, DEFENSE, 10)));
    _allRooms.push_back(unique_ptr<Room>(new Trap(TRAP, "FUMEE MALEFIQUE", "Un nuage de fumee multicolore vous entoure. Quand il se dissipe, vous vous rendez compte qu'il vous a pris toute votre armure. Heureusement vous avez encore votre pagne.", TRAP_7_IMAGE_PATH, DEFENSE, 10)));
    _allRooms.push_back(unique_ptr<Room>(new Trap(TRAP, "FUMEE MALEFIQUE", "Un nuage de fumee multicolore vous entoure. Quand il se dissipe, vous vous rendez compte qu'il vous a pris toute votre armure. Heureusement vous avez encore votre pagne.", TRAP_7_IMAGE_PATH, DEFENSE, 10)));
    // 60 CARDS
    ...
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, true, "BOSS DU DONJON :\nCHEF ORC", "Il s'agit de l'orc alpha. Il n'aime visiblement pas du tout qu'on le derange pendant sa sieste ...", BOSS_2_IMAGE_PATH, 60, 5, 300, 100)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, true, "BOSS DU DONJON :\nDRACULA", "Le roi des vampires en chair et en os ... et en dents. Peut-etre que bruler vivante son ame soeur n'etait pas la meilleure chose a faire avant de partir ... ", BOSS_3_IMAGE_PATH, 100, 5, 200, 100)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, true, "BOSS DU DONJON :\nDRACULA", "Le roi des vampires en chair et en os ... et en dents. Peut-etre que bruler vivante son ame soeur n'etait pas la meilleure chose a faire avant de partir ... ", BOSS_3_IMAGE_PATH, 100, 5, 200, 100)));
    ...
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, true, "BOSS DU DONJON :\nGROSSE BESTIOLE", "Vous ne savez pas vraiment ce que c'est mais c'est sacrement moche alors il vaudrait mieux s'en debarrasser rapidement.", BOSS_4_IMAGE_PATH, 45, 25, 200, 100)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, true, "BOSS DU DONJON :\nCHIEN A TROIS TETES", "J'espere que vous avez pris votre flute. Non ? Bon, je pense qu'il faudra se contenter de votre bonne vieille epee...", BOSS_5_IMAGE_PATH, 50, 10, 400, 100)));
    _allRooms.push_back(unique_ptr<Room>(new Monster(MONSTER, true, "BOSS DU DONJON :\nCHIEN A TROIS TETES", "J'espere que vous avez pris votre flute. Non ? Bon, je pense qu'il faudra se contenter de votre bonne vieille epee...", BOSS_5_IMAGE_PATH, 50, 10, 400, 100)));
    // 100 CARDS
}
